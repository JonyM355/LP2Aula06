...
namespace FileStreams
{
    public class Program
    {
        ...
        {
            FileStream fileStream = File.OpenWrite(filenameText);
        ...
        private static void LerTexto()
        {
            ...
            int readInt = int.Parse(sr.ReadLine());
            float readFloat = float.Parse(sr.ReadLine());
        ...
        {
            FileStream fileStream = File.OpenWrite(filenameBinary);
        ...
        {
            FileStream fileStream = File.OpenRead(filenameBinary);
